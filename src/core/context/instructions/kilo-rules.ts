...
/**
 * Converts .8thwallagent/rules file to directory and places old .8thwallagent/rules file inside directory, renaming it
 * Doesn't do anything if .8thwallagent/rules dir already exists or doesn't exist
