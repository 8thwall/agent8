...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with 8th Wall Agent",
	FIX: "Fix with 8th Wall Agent",
	IMPROVE: "Improve with 8th Wall Agent",
	ADD_TO_CONTEXT: "Add to 8th Wall Agent",
	NEW_TASK: "New 8th Wall Agent Task",
} as const
