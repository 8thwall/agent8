...
const objectIdsSchema = z
  ...
  .describe('An array of entity IDs.')
...
const pathsSchema = z
  .array(pathSchema)
  .describe(
    'An array of paths to get. If an empty array is provided, all properties are returned.',
  )
...
const pathValuesSchema = z
  .record(pathSchema, pathValueSchema)
...
export type {ObjectIds, BaseGraphObject, Path, Paths, PathValue, PathValues}
