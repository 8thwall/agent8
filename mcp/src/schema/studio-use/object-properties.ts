...
const getObjectsPropertyRequestSchema = z.object({
  objects: z
    ...
    .min(1)
    .describe('Array of objects to get properties for.'),
})
...
const setObjectsPropertyRequestSchema = z.object({
  objects: z
    ...
    .min(1)
    .describe('Array of objects to set properties for.'),
})
...
export {getObjectsPropertyRequestSchema, setObjectsPropertyRequestSchema}
